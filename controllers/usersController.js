...
const createNewUser = asyncHandler(async (req, res) => {
    ...
    //find out if there's a duplicate
    const duplicate = await User.findOne({ username }).collation({ locale: 'en', strength: 2 }).lean().exec(); //collation makes uname case-insensitive
